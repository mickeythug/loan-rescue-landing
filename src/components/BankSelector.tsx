  ...
  return (
    <div>
      ...
      <Select value={value} onValueChange={onChange}>
        ...
        <SelectContent className="max-h-60 bg-white border-2 border-gray-200 rounded-xl shadow-lg">
          <div className="p-2 sticky top-0 bg-white border-b">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9 h-9 text-sm border-gray-300 rounded-lg"
              />
            </div>
          </div>
          {filteredBanks.map((bank) => (
            <SelectItem 
              key={bank} 
              value={bank}
              className="text-base py-2 px-3 hover:bg-blue-50 cursor-pointer"
            >
              {bank}
            </SelectItem>
          ))}
